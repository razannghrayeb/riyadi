...
countries_codes = {
    ...
    "MS", "MA", "MZ", "MM", "NA", "NR", "NP", "NL", "AN", "NC",
    "NZ", "NI", "NE", "NG", "NU", "NF", "MP", "NO", "OM", "PK",
    "PW", "PS", "PA", "PG", "PY", "PE", "PH", "PN", "PL", "PT",
    "PR", "QA", "RE", "RO", "RU", "RW", "BL", "SH", "KN", "LC",
    "MF", "PM", "VC", "WS", "SM", "ST", "SA", "SN", "RS", "CS",
...
def check_if_country_valid(value):
    
    if value not in countries_codes:
        return False
...
def is_strong_password(password):
    ...
    return HasDigit and HasSpecial and HasUpperCase